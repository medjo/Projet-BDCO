...
public class Deplacement extends Action{
	...
	public void save() throws ExceptionDeplacement {
		ParamQuery req = new ParamQuery(BattleShip.theConnection.getConnection(),"INSERT INTO Actions "
				+ "														VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?)");
		try{
			...
			req.getStatement().setString(8, "Dep");
			System.out.println("Mouv:"+type.toString());
			req.getStatement().setString(9, type.toString());
